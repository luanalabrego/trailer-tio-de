        ...
        <div className="bg-white p-4 rounded-xl shadow space-y-6 mb-8">
            ...
            {itens.length===0
              ...
              : (
                <ul className="space-y-2">
                  {itens.map(item=>(
                    <li key={item.id} className="bg-gray-50 p-3 rounded flex flex-col gap-2">
          ...
          {saleType==='paid' && (
            <div className="space-y-4">
              <button onClick={()=>setSaleType(null)} className="text-gray-600 hover:underline">&larr; Voltar</button>
              <select
      ...
      {showFinalModal && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-sm">
            ...
            <div className="flex gap-4">
              <button
                onClick={() => { handleImprimir(); setShowFinalModal(false) }}
